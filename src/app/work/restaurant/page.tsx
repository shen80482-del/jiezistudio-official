        ...
        <div className="rounded-[2.5rem] bg-[#efe0c5] p-4 sm:p-6">
          <div className="rounded-[2rem] bg-[#fffaf0] p-8 sm:p-12">
            ...
            <div className="mt-10 max-w-4xl">
              ...
              <p className="mt-5 text-2xl font-semibold leading-snug text-[#5b1f1f]">把一顿饭，变成一段被记住的日常。</p>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-[#705844]">适合餐厅、咖啡店、甜品店展示品牌故事、菜单和餐厅门店信息。这个演示站强调温暖、生活感和可预约的商业路径。</p>
            </div>
      ...
      <section className="mx-auto grid w-[min(1120px,calc(100%-32px))] gap-8 pb-20 lg:grid-cols-[1fr_0.86fr]">
        ...
        <article className="rounded-[2rem] border border-[#dfc9a5] bg-[#fffaf0] p-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-3">
            <span className="h-36 rounded-[1.5rem] bg-[#efe0c5]" />
            <span className="h-36 rounded-[1.5rem] bg-[#c68b59]" />
            <span className="col-span-2 h-28 rounded-[1.5rem] bg-[#5b1f1f]" />
          </div>
